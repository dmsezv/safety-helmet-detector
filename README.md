...
Проект использует **DVC** для управления версиями датасета. Сами изображения хранятся в облаке (Google Drive), а в Git попадают только легковесные метаданные (`.dvc` файлы).
